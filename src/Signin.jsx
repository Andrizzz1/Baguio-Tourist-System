    ...
    return (
        <section className="min-h-screen bg-green-50 grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="flex items-center justify-center p-8">
                <button
                    onClick={() => navigate('/')}
                    className="z-20 absolute top-5 left-4 hover:bg-black/10 p-1 rounded-2xl transition-all delay-100"
                >
                    <ArrowUturnLeftIcon className="w-6 h-6 text-green-900" />
                </button>

                <div className="w-full max-w-md">
                    <h2 className="text-green-900 font-bold text-3xl">Welcome Back</h2>
                    ...
                    <p className="text-center text-gray-400 text-sm mt-6">
                        ...
                        <span onClick={() => navigate('/Register')} className="text-green-800 font-semibold cursor-pointer hover:underline">Sign up</span>
                    </p>
                </div>
            </div>
            ...
            >
                ...
                <div className="relative z-10">
                    <p className="text-green-300 text-sm font-semibold uppercase tracking-widest mb-2">City of Pines</p>
                    <h1 className="text-white font-bold text-5xl leading-tight">Your Journey<br />Awaits</h1>
                    <p className="text-green-200 mt-4 max-w-sm">Explore hidden gems, local favorites, and AI-powered travel tips — all in one place.</p>
                </div>
            </div>
