    ...
    return <section>
        <div className="h-[calc(100vh-80px)] bg-cover bg-center rounded-t-xl  bg-black/50 bg-blend-darken" 
             style={{backgroundImage:"url('/imgs/background.png')"}}>
                <div className='px-65 py-40 max-lg:px-30 max-md:px-20 max-sm:px-5'>
                    <TypeAnimation
                        sequence={[
                    ...
                    <div className='flex  items-center mt-5 gap-5 max-w-xl'>
                        <a href="#" className='bg-green-900 text-white py-2 px-5 rounded-4xl'>LOGIN</a>
                        <a href="#" className='bg-green-900 text-white py-2 px-5 rounded-4xl'>CHAT WITH AI</a>
                    </div>
                </div>    
