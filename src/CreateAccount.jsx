            ...
            <div className="flex items-center justify-center p-8">
                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        {/* Facebook Button (Replaced GitHub) */}
                        <button className="flex items-center justify-center gap-3 w-full border border-gray-200 bg-white hover:bg-gray-50 transition-colors py-2.5 rounded-xl font-medium text-gray-700">
                            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                                <path d="M22.675 0h-21.35C.595 0 0 .593 0 1.326v21.348C0 23.406.595 24 1.325 
                                24h11.495v-9.294H9.692V11.01h3.128V8.414c0-3.1 
                                1.894-4.788 4.659-4.788 1.325 0 2.463.099 
                                2.794.143v3.24l-1.918.001c-1.504 0-1.796.715-1.796 
                                1.763v2.313h3.587l-.467 3.696h-3.12V24h6.116C23.405 
                                24 24 23.406 24 22.674V1.326C24 .593 23.405 0 
                                22.675 0z"/>
                            </svg>
                    ...
                    <p className="text-center text-gray-400 text-sm mt-6">
                        ...
                        <span onClick={() => navigate('/Signin')} className="text-green-800 font-semibold cursor-pointer hover:underline">
                            Sign in
                        </span>
                    </p>
                </div>
