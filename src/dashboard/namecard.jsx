export const NameCard = ()=>{
    ...
    return <section className="text-black flex justify-center m-5">
        <div className="relative overflow-hidden p-10 rounded-3xl bg-cover bg-center text-white w-7xl" 
        style={{backgroundImage:`linear-gradient(120deg, rgba(4, 120, 87, 0.92), rgba(6, 95, 70, 0.72)),url('/imgs/bg.png')`}}>
            <div className="text-white text-sm bg-emerald-500 w-fit py-1 px-2  rounded-2xl">weather</div>
                <div>
                    <h1 className="font-semibold text-emerald-50 text-2xl">Kamusta, {firstName}!</h1>
                </div>
